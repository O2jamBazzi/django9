...
from .models import *
#view : 사용자의 요청에 따라 처리하고, HTML파일이나 새로운 URL 주소를 전송함
#view 정의 시 함수 / 클래스 형태로 정의

#view 함수 정의시 첫번째 매게변수로 request 변수를 사용함
